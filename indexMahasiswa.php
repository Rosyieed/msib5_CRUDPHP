...
$conn = mysqli_query($mysqli, 'SELECT * FROM mahasiswa');
?>
        ...
        <div class="body-content h-100">
            <div class="row g-0 h-100">
                ...
                <div class="content p-5 col-lg-10" style="background-color: #f2f2f2;">
                    <div class="container-mahasiswa p-3 rounded" style="background-color: #fff">
                        <h1>List Mahasiswa</h1>
                        <div class="my-4 d-flex justify-content-start">
                            <a href="addMahasiswa.php" class="btn btn-primary"><i class="bi bi-plus-circle me-2"></i>Tambah Data Mahasiswa</a>
                        </div>
                        <hr>

                        <?php

                        $total_rows = mysqli_num_rows(mysqli_query($mysqli, 'SELECT * FROM mahasiswa'));
                        ...
                        $result = mysqli_query($mysqli, "SELECT * FROM mahasiswa LIMIT $offset, $per_page");
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="editMahasiswa.php?id=<?php echo $user_data['nim']; ?>" class="btn text-white" style="background-color: rgb(49, 211, 0)"><i class="bi bi-subtract me-2"></i>Edit</a>
                                            <a href="deleteMahasiswa.php?id=<?php echo $user_data['nim']; ?>" class="btn text-white delete" style="background-color: rgb(211, 18, 0)" id="delete" onclick="confirmation(event)"><i class="bi bi-trash me-2"></i>Delete</a>
